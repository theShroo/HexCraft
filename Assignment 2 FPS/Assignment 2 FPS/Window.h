...
private:
	...
	LPCWSTR m_windowName;	//The name of the Window (also used as the name of the window class) NOTE: LPCSTR is Windows syntax for a const char*
...
// Global variables: just say no.
	...
	Window(LPCWSTR windowName, int width, int height, bool fullscreen);	//A simple constructor used to set some initial values
	~Window();	//Destructor
...
LRESULT CALLBACK WindowProc(HWND, UINT, WPARAM, LPARAM);	//Here is our real Window Procedure function, however it is declared in global
